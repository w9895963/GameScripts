...
namespace Global {
    namespace Animation {
        public static class AnimateUtility {
            ...
            public const string FlipXattribute = "FlipX";

            public static GameObject SetAnimation (GameObject gameObject, AnimationObject animation) {
            ...
            public static TimerControler SetTextureAnimate (GameObject gameobject, TextureAnimation textureAnimation) {
        ...
        [System.Serializable] public class TextureAnimation {
